<html>
  ...
  <?php
		...
		foreach($values as $value){
			...
			<td>
			<a href="modifier_patients.php?id=<?php echo $value['id']?>" class="btn">modifier</a>
			<a href="supprimer_patients.php?id=<?php echo $value['id']?>" onclick="return confirm('vouler vous supprimer ');" class="btn">supprimer</a>
		<?php
		}
?>
</tbody>
